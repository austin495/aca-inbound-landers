...
<body>
    <section class="hero-section">
        <div class="hero container">
            <div class="hero-text">
                <h1>2025 Subsidy Program<br>Get Up to <span>$6,140</span> in Savings!</h1>
                <p>Secure your support fund Now to cover healthcare costs, giving you more freedom to spend</p>
                <a href="#form" class="btn">See If You Qualify!</a>
                <p class="under-btn">Final Call! Lock In Your Reward Before the Deadline!</p>
            </div>
            <div class="hero-img">
                <img src="/images/hero-img.webp" alt="Credit Card">
            </div>
        </div>
    </section>
    ...
    <section class="form-heading-section">
        <div class="form-heading container">
            <div class="form-heading">
                <h2><span>Secure your support fund Now</span> to cover healthcare costs, giving you more freedom to spend on groceries, fuel, housing, and more, <span>even with $0 health plans.</span></h2>
            </div>
        </div>
    </section>
